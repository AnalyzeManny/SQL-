...
-- EXTRACT A TABLE OF INDIVIDUALS COST (PROCEDURE PRICES) INCURRED BY OWNERS OF PETS FROM THE CLINIC IN QUESTION 
-- (THIS TABLE SHOULD HAVE OWNER & PROCEDURE SIDE-BY-SIDE)
SELECT
	ProceduresHistory.ProcedureType
FROM Owners
	JOIN (
